...
void UAuraAbilitySystemLibrary::SetIsSuccessfulDebuff(FGameplayEffectContextHandle& EffectContextHandle,
	bool bInIsSuccessful){
	if(FAuraGameplayEffectContext* AuraEffectContext = static_cast<FAuraGameplayEffectContext*>(EffectContextHandle.Get())){
		AuraEffectContext->SetIsSuccessfulDebuff(bInIsSuccessful);
	}
}
...
void UAuraAbilitySystemLibrary::SetKnockForce(FGameplayEffectContextHandle& EffectContextHandle, const FVector& InForce){
	if(FAuraGameplayEffectContext* AuraEffectContext = static_cast<FAuraGameplayEffectContext*>(EffectContextHandle.Get())){
		AuraEffectContext->SetKnockForce(InForce);
	}
}
...
bool UAuraAbilitySystemLibrary::IsNotFriend(AActor* FirstActor, AActor* SecondActor){	
	...
	const bool bFriends = bBothAreEnemy || bBothArePlayers;
	return !bFriends;
}
